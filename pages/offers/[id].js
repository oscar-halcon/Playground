...
const Details = ({offer}) => {
    return ( 
        <div>
            <table>
                <tr>
                    <th>ID</th><th>{offer.id}</th>
                </tr>
                <tr>
                    <th>Annual Salary</th><th>{offer.Annual_salary}</th>
                </tr>
            </table>
            <h4>ID: {offer.id}</h4>
            ...
            <h4>Value equity in offer: {offer.Number_options * offer.Current_FMV_company}</h4>
            <h4>Company Increase x5: {((offer.Number_options * offer.Current_FMV_company)*5)}</h4>
            <h4>Company Falls x5: {(offer.Number_options * offer.Current_FMV_company)/5}</h4>
